...
theme.set_highlights = function()
	...
	hl(0, "qfLineNr", { fg = c.ui_orange, bg = "NONE" })
	...
	hl(0, "@symbol", { link = "Identifier", bg = "NONE" })
	hl(0, "@text", { link = "None" })
	...
	-- Markdown
	hl(0, "@text.reference.markdown_inline", { fg = c.green, bg = "NONE" })
	...
	hl(0, "@text.literal.markdown_inline", { fg = c.green, bg = "NONE" })
	hl(0, "@text.literal.markdown", { fg = c.green, bg = "NONE" })
	hl(0, "@markup.link.label.markdown_inline", { fg = c.green, bg = "NONE" })
	...
	hl(0, "@markup.raw.markdown_inline", { fg = c.green, bg = "NONE" })
	...
	hl(0, "LazyCommit", { fg = c.ui_orange, bg = "NONE" })
	...
	-- Neogit
	hl(0, "NeogitRemote", { fg = c.ui_orange, bg = "NONE" })
	...
	hl(0, "NeogitBranch", { fg = c.ui_orange, bg = "NONE" })
	...
	hl(0, "gitcommitBranch", { fg = c.ui_orange, bg = "NONE" })
	...
	-- Mini Icons
	hl(0, "MiniIconsAzure", { fg = c.ui_azure, bg = "NONE" })
	hl(0, "MiniIconsBlue", { fg = c.ui_blue, bg = "NONE" })
	hl(0, "MiniIconsCyan", { fg = c.ui_cyan, bg = "NONE" })
	hl(0, "MiniIconsGreen", { fg = c.ui_green, bg = "NONE" })
	hl(0, "MiniIconsGrey", { fg = c.light_grey_4, bg = "NONE" })
	hl(0, "MiniIconsOrange", { fg = c.ui_orange, bg = "NONE" })
	hl(0, "MiniIconsPurple", { fg = c.ui_purple, bg = "NONE" })
	hl(0, "MiniIconsRed", { fg = c.ui_red, bg = "NONE" })
	hl(0, "MiniIconsYellow", { fg = c.ui_yellow, bg = "NONE" })
	...
	-- blink
	hl(0, "BlinkCmpMenu", { fg = c.fg, bg = c.dark_grey_3 })
	hl(0, "BlinkCmpMenuBorder", { fg = c.dark_grey_4, bg = c.dark_grey_3 })
	hl(0, "BlinkCmpMenuSelection", { fg = "NONE", bg = c.select })
	hl(0, "BlinkCmpDoc", { fg = c.fg, bg = c.alt_bg })
	hl(0, "BlinkCmpDocBorder", { fg = c.dark_grey_4, bg = c.alt_bg })
	hl(0, "BlinkCmpDocHeader", { fg = c.fg, bg = c.alt_bg, bold = true })
	hl(0, "BlinkCmpDocScroller", { fg = c.dark_grey_4, bg = c.dark_grey_3 })
	hl(0, "BlinkCmpDocSeparator", { bg = c.dark_grey_3 })
	hl(0, "BlinkCmpDocCursorLine", { fg = c.fg, bg = c.visual })
	hl(0, "BlinkCmpGhostText", { fg = c.dark_grey_4, italic = true })
	hl(0, "BlinkCmpScrollBarThumb", { fg = c.dark_grey_4, bg = c.dark_grey_4 })
	hl(0, "BlinkCmpScrollBarGutter", { fg = c.dark_grey_2, bg = c.dark_grey_3 })

	hl(0, "BlinkCmpLabel", { fg = c.light_grey_3 })
	hl(0, "BlinkCmpLabelDeprecated", { fg = c.light_grey_4, strikethrough = true })
	hl(0, "BlinkCmpLabelMatch", { fg = c.fg, bold = true })
	hl(0, "BlinkCmpKindText", { fg = c.green })
	hl(0, "BlinkCmpKindMethod", { fg = c.blue })
	hl(0, "BlinkCmpKindFunction", { fg = c.blue })
	hl(0, "BlinkCmpKindConstructor", { fg = c.blue })
	hl(0, "BlinkCmpKindField", { fg = c.green })
	hl(0, "BlinkCmpKindVariable", { fg = c.red })
	hl(0, "BlinkCmpKindClass", { fg = c.yellow })
	hl(0, "BlinkCmpKindInterface", { fg = c.yellow })
	hl(0, "BlinkCmpKindModule", { fg = c.blue })
	hl(0, "BlinkCmpKindProperty", { fg = c.blue })
	hl(0, "BlinkCmpKindUnit", { fg = c.green })
	hl(0, "BlinkCmpKindValue", { fg = c.yellow })
	hl(0, "BlinkCmpKindEnum", { fg = c.yellow })
	hl(0, "BlinkCmpKindKeyword", { fg = c.purple })
	hl(0, "BlinkCmpKindSnippet", { fg = c.red })
	hl(0, "BlinkCmpKindColor", { fg = c.red })
	hl(0, "BlinkCmpKindFile", { fg = c.blue })
	hl(0, "BlinkCmpKindReference", { fg = c.red })
	hl(0, "BlinkCmpKindFolder", { fg = c.blue })
	hl(0, "BlinkCmpKindEnumMember", { fg = c.cyan })
	hl(0, "BlinkCmpKindConstant", { fg = c.yellow })
	hl(0, "BlinkCmpKindStruct", { fg = c.blue })
	hl(0, "BlinkCmpKindEvent", { fg = c.blue })
	hl(0, "BlinkCmpKindOperator", { fg = c.cyan })
	hl(0, "BlinkCmpKindTypeParameter", { fg = c.red })
	hl(0, "BlinkCmpKindCopilot", { fg = c.cyan })

	hl(0, "BlinkCmpSource", { fg = c.light_grey_4, bg = c.dark_grey_3 })
	hl(0, "BlinkCmpSignatureHelp", { fg = c.fg, bg = c.dark_grey_3 })
	hl(0, "BlinkCmpSignatureHelpBorder", { fg = c.dark_grey_4, bg = c.dark_grey_3 })
	hl(0, "BlinkCmpSignatureHelpActiveParameter", { fg = c.info, bg = c.dark_grey_3, bold = true })
end
