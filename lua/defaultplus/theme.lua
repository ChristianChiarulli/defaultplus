...
theme.set_highlights = function()
	...
	hl(0, "BlinkCmpLabelDeprecated", { fg = c.light_grey_4, bg = "NONE", strikethrough = true })
	hl(0, "BlinkCmpMenuBorder", { fg = c.dark_grey_4, bg = "NONE" })
	hl(0, "BlinkCmpMenuSelection", { fg = "NONE", bg = c.visual })
	hl(0, "BlinkCmpKind", { fg = c.fg, bg = "NONE" })
	...
	hl(0, "BlinkCmpKindEvent", { fg = c.ui_orange, bg = "NONE" })
	hl(0, "BlinkCmpKindInterface", { fg = c.ui_orange, bg = "NONE" })
	hl(0, "BlinkCmpKindStruct", { fg = c.ui_orange, bg = "NONE" })
	hl(0, "BlinkCmpKindVariable", { fg = c.blue, bg = "NONE" })
	hl(0, "BlinkCmpKindField", { fg = c.blue, bg = "NONE" })
	hl(0, "BlinkCmpKindProperty", { fg = c.blue, bg = "NONE" })
	hl(0, "BlinkCmpKindEnumMember", { fg = c.fg, bg = "NONE" })
	hl(0, "BlinkCmpKindConstant", { fg = c.fg, bg = "NONE" })
	...
	hl(0, "BlinkCmpKindReference", { fg = c.ui_green, bg = "NONE" })
	hl(0, "BlinkCmpKindOperator", { fg = c.fg, bg = "NONE" })
	hl(0, "BlinkCmpKindTypeParameter", { fg = c.ui_orange, bg = "NONE" })
